...
from opsec_app.EC2_cost_other.serializers import OT_US
...
def ec2_OTU():
    ...
    cost_com = ce.get_cost_and_usage(
        ...
        Granularity = 'MONTHLY',
     Filter={ "And": [ {"Dimensions": { "Key": "SERVICE", "Values": ["EC2 - Other"] }}, {"Not": {"Dimensions": { "Key": "RECORD_TYPE", "Values": ["Credit"] }}},{"Not": {"Dimensions": { "Key": "RECORD_TYPE", "Values": ["Refund"] }}}  ] }
